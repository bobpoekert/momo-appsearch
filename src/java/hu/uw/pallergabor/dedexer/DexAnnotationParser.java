...
/**
  ...
  */
    ...
    public List<AnnotationHolder> getFieldAnnotations() {
        return this.fieldAnnotationHolders;
    }

    public List<AnnotationHolder> getMethodAnnotations() {
        return this.methodAnnotationHolders;
    }

    public List<AnnotationHolder> getParameterAnnotations() {
        return this.parameterAnnotationHolders;
    }

    public List<AnnotationHolder> getClassAnnotations() {
        return this.classAnnotationHolders;
    }
