...
vec_model.load_model('./english.sent2vec.bin')
...
string_table = sstable.SSTable('strings.sstable', 'strings.txt.sstable')
...
def neighbors(instring, k=20):
    ...
    neighbor_strings = [string_table.read_idx(i).decode('utf-8') for i in neighbors]
